...
type WorkflowSummarizedFiltersInner struct {
	...
	View WorkflowSummarizedFiltersInnerView `json:"view"`
...
func NewWorkflowSummarizedFiltersInner(id string, type_ ENUMPROPERTIESDATAITEMSPROPERTIESFILTERSITEMSPROPERTIESTYPE, view WorkflowSummarizedFiltersInnerView) *WorkflowSummarizedFiltersInner {
