...
func NewCreateAssetMCPRequest(assetClass ENUMAPISERVICE, url string, assetType ENUMMCP) *CreateAssetMCPRequest {
...
func (o *CreateAssetMCPRequest) GetParents() []CreateAssetDNSRequestParentsInner {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetMCPRequest) GetParentsOk() ([]CreateAssetDNSRequestParentsInner, bool) {
	if o == nil || IsNil(o.Parents) {
		return nil, false
	}
...
func (o *CreateAssetMCPRequest) HasParents() bool {
	if o != nil && !IsNil(o.Parents) {
		return true
	}
...
func (o *CreateAssetMCPRequest) SetParents(v []CreateAssetDNSRequestParentsInner) {
	o.Parents = v
}

// GetChildrens returns the Childrens field value if set, zero value otherwise.
func (o *CreateAssetMCPRequest) GetChildrens() []CreateAssetDNSRequestParentsInner {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetMCPRequest) GetChildrensOk() ([]CreateAssetDNSRequestParentsInner, bool) {
	if o == nil || IsNil(o.Childrens) {
		return nil, false
	}
...
func (o *CreateAssetMCPRequest) HasChildrens() bool {
	if o != nil && !IsNil(o.Childrens) {
		return true
	}
...
func (o *CreateAssetMCPRequest) SetChildrens(v []CreateAssetDNSRequestParentsInner) {
	o.Childrens = v
}
