...
// ScanDetailed The most recent scan for this profile
...
func NewScanDetailed(id string, status string, createdAt string, updatedAt string, finishedAt NullableString, score NullableFloat32, coverage NullableFloat32, duration float32, progressRatio float32, initiator string, kind string, profileId string, organizationId string, commitHash NullableString, commitBranch NullableString, commitAuthor NullableString, commitLink NullableString, commitAuthorProfilePictureLink NullableString, links ScanDetailedLinks) *ScanDetailed {
	this := ScanDetailed{}
	this.Id = id
	this.Status = status
...
// If the value is explicit nil, the zero value for float32 will be returned
func (o *ScanDetailed) GetCoverage() float32 {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *ScanDetailed) GetCoverageOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed) SetCoverage(v float32) {
	o.Coverage.Set(&v)
}
