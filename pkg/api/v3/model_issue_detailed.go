...
func NewIssueDetailed(id string, name string, fullName string, category ENUMPROPERTIESDATAITEMSPROPERTIESCATEGORY, severity ENUMPROPERTIESDATAITEMSPROPERTIESSEVERITY, status ENUMPROPERTIESDATAITEMSPROPERTIESSTATUS, risks []ENUMPROPERTIESDATAITEMSPROPERTIESASSETPROPERTIESRISKSITEMS, alertUid string, createdAt string, asset AssetDetailed1, aiRemediationFramework string, links IssueSummarizedLinks) *IssueDetailed {
	this := IssueDetailed{}
	this.Id = id
	this.Name = name
...
func (o *IssueDetailed) GetFullName() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *IssueDetailed) GetFullNameOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IssueDetailed) SetFullName(v string) {
	o.FullName = v
}

// GetCategory returns the Category field value
func (o *IssueDetailed) GetCategory() ENUMPROPERTIESDATAITEMSPROPERTIESCATEGORY {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *IssueDetailed) GetCategoryOk() (*ENUMPROPERTIESDATAITEMSPROPERTIESCATEGORY, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *IssueDetailed) SetCategory(v ENUMPROPERTIESDATAITEMSPROPERTIESCATEGORY) {
	o.Category = v
}
...
func (o *IssueDetailed) GetAsset() AssetDetailed1 {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *IssueDetailed) GetAssetOk() (*AssetDetailed1, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Asset, true
...
func (o *IssueDetailed) SetAsset(v AssetDetailed1) {
	o.Asset = v
}
