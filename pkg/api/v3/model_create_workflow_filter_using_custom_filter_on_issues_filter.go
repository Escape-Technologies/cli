...
func (o *CreateWorkflowFilterUsingCustomFilterOnIssuesFilter) GetTagsIds() []string {
...
// and a boolean to check if the value has been set.
func (o *CreateWorkflowFilterUsingCustomFilterOnIssuesFilter) GetTagsIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.TagsIds) {
		return nil, false
	}
...
func (o *CreateWorkflowFilterUsingCustomFilterOnIssuesFilter) HasTagsIds() bool {
	if o != nil && !IsNil(o.TagsIds) {
		return true
	}
...
func (o *CreateWorkflowFilterUsingCustomFilterOnIssuesFilter) SetTagsIds(v []string) {
	o.TagsIds = v
}
