...
func (o *CreateAssetRESTRequest) GetProjectIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
func (o *CreateAssetRESTRequest) GetProjectIdsOk() ([]string, bool) {
...
func (o *CreateAssetRESTRequest) HasProjectIds() bool {
	if o != nil && !IsNil(o.ProjectIds) {
		return true
	}
...
func (o *CreateAssetRESTRequest) SetProjectIds(v []string) {
	o.ProjectIds = v
}
...
func (o *CreateAssetRESTRequest) UnsetName() {
	o.Name.Unset()
}
...
func (o *CreateAssetRESTRequest) UnsetScreenshotS3Key() {
...
func (o *CreateAssetRESTRequest) UnsetFavicon() {
	o.Favicon.Unset()
}
...
func (o *CreateAssetRESTRequest) UnsetReachableViaExternalProxy() {
...
func (o *CreateAssetRESTRequest) UnsetPrivate() {
	o.Private.Unset()
}
...
func (o *CreateAssetRESTRequest) UnsetPrivateLocationId() {
...
func (o *CreateAssetRESTRequest) UnsetEnvironment() {
	o.Environment.Unset()
}
...
func (o *CreateAssetRESTRequest) UnsetCloudProvider() {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreateAssetRESTRequest) GetAuthProtocolOk() (*ENUMPROPERTIESAUTHPROTOCOL, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateAssetRESTRequest) HasAuthProtocol() bool {
...
func (o *CreateAssetRESTRequest) UnsetAuthProtocol() {
...
func (o *CreateAssetRESTRequest) GetAuthTechnology() ENUMPROPERTIESDATAITEMSPROPERTIESASSETPROPERTIESSERVICEPROPERTIESAUTHTECHNOLOGY {
...
// and a boolean to check if the value has been set.
// NOTE: If the value is an explicit nil, `nil, true` will be returned
func (o *CreateAssetRESTRequest) GetAuthTechnologyOk() (*ENUMPROPERTIESDATAITEMSPROPERTIESASSETPROPERTIESSERVICEPROPERTIESAUTHTECHNOLOGY, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateAssetRESTRequest) HasAuthTechnology() bool {
...
func (o *CreateAssetRESTRequest) UnsetAuthTechnology() {
...
func (o *CreateAssetRESTRequest) UnsetThirdParty() {
	o.ThirdParty.Unset()
}
...
// GetOpenapiUrl returns the OpenapiUrl field value if set, zero value otherwise (both if not set or set to explicit null).
func (o *CreateAssetRESTRequest) GetOpenapiUrl() string {
	if o == nil || IsNil(o.OpenapiUrl.Get()) {
		var ret string
		return ret
	}
	return *o.OpenapiUrl.Get()
}
...
// SetOpenapiUrl gets a reference to the given NullableString and assigns it to the OpenapiUrl field.
...
// UnsetOpenapiUrl ensures that no value is present for OpenapiUrl, not even an explicit nil
func (o *CreateAssetRESTRequest) UnsetOpenapiUrl() {
	o.OpenapiUrl.Unset()
}
...
func (o CreateAssetRESTRequest) ToMap() (map[string]interface{}, error) {
	...
	if o.OpenapiUrl.IsSet() {
		toSerialize["openapi_url"] = o.OpenapiUrl.Get()
	}
