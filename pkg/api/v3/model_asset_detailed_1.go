...
func (o *AssetDetailed1) GetProjectIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AssetDetailed1) GetProjectIdsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AssetDetailed1) SetProjectIds(v []string) {
	o.ProjectIds = v
}
...
func (o *AssetDetailed1) GetTechnology() AssetTechnologyDetailed {
...
// and a boolean to check if the value has been set.
func (o *AssetDetailed1) GetTechnologyOk() (*AssetTechnologyDetailed, bool) {
	if o == nil || IsNil(o.Technology) {
		return nil, false
	}
...
func (o *AssetDetailed1) HasTechnology() bool {
	if o != nil && !IsNil(o.Technology) {
		return true
	}
...
func (o *AssetDetailed1) SetTechnology(v AssetTechnologyDetailed) {
	o.Technology = &v
}
...
func (o *AssetDetailed1) HasSchemaUrl() bool {
	if o != nil && !IsNil(o.SchemaUrl) {
		return true
	}
