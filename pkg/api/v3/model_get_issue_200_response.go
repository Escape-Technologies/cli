...
type GetIssue200Response struct {
	...
	Asset     AssetDetailed1 `json:"asset"`
...
func NewGetIssue200Response(id string, name string, fullName string, category ENUMPROPERTIESDATAITEMSPROPERTIESCATEGORY, severity ENUMPROPERTIESDATAITEMSPROPERTIESSEVERITY, status ENUMPROPERTIESDATAITEMSPROPERTIESSTATUS, risks []ENUMPROPERTIESDATAITEMSPROPERTIESASSETPROPERTIESRISKSITEMS, alertUid string, createdAt string, asset AssetDetailed1, aiRemediationFramework string, links IssueSummarizedLinks) *GetIssue200Response {
...
func (o *GetIssue200Response) GetAsset() AssetDetailed1 {
	if o == nil {
		var ret AssetDetailed1
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *GetIssue200Response) GetAssetOk() (*AssetDetailed1, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Asset, true
...
func (o *GetIssue200Response) SetAsset(v AssetDetailed1) {
	o.Asset = v
}
