...
func NewCreateAssetWEBAPPRequest(assetClass ENUMFRONTEND, url string, assetType ENUMWEBAPP) *CreateAssetWEBAPPRequest {
...
func (o *CreateAssetWEBAPPRequest) GetParents() []CreateAssetDNSRequestParentsInner {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetWEBAPPRequest) GetParentsOk() ([]CreateAssetDNSRequestParentsInner, bool) {
	if o == nil || IsNil(o.Parents) {
		return nil, false
	}
...
func (o *CreateAssetWEBAPPRequest) HasParents() bool {
	if o != nil && !IsNil(o.Parents) {
		return true
	}
...
func (o *CreateAssetWEBAPPRequest) SetParents(v []CreateAssetDNSRequestParentsInner) {
	o.Parents = v
}

// GetChildrens returns the Childrens field value if set, zero value otherwise.
func (o *CreateAssetWEBAPPRequest) GetChildrens() []CreateAssetDNSRequestParentsInner {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetWEBAPPRequest) GetChildrensOk() ([]CreateAssetDNSRequestParentsInner, bool) {
	if o == nil || IsNil(o.Childrens) {
		return nil, false
	}
...
func (o *CreateAssetWEBAPPRequest) HasChildrens() bool {
	if o != nil && !IsNil(o.Childrens) {
		return true
	}
...
func (o *CreateAssetWEBAPPRequest) SetChildrens(v []CreateAssetDNSRequestParentsInner) {
	o.Childrens = v
}
