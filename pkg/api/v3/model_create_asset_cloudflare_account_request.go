...
func (o *CreateAssetCLOUDFLAREACCOUNTRequest) GetProjectIds() []string {
...
func (o *CreateAssetCLOUDFLAREACCOUNTRequest) GetProjectIdsOk() ([]string, bool) {
	if o == nil || IsNil(o.ProjectIds) {
		return nil, false
	}
...
func (o *CreateAssetCLOUDFLAREACCOUNTRequest) HasProjectIds() bool {
	if o != nil && !IsNil(o.ProjectIds) {
		return true
	}
...
func (o *CreateAssetCLOUDFLAREACCOUNTRequest) SetProjectIds(v []string) {
	o.ProjectIds = v
}
