...
func (o *GetProfile200ResponseConfiguration) GetProfile() ENUMPROPERTIESCONFIGURATIONPROPERTIESPROFILE {
...
// and a boolean to check if the value has been set.
func (o *GetProfile200ResponseConfiguration) GetProfileOk() (*ENUMPROPERTIESCONFIGURATIONPROPERTIESPROFILE, bool) {
	if o == nil || IsNil(o.Profile) {
		return nil, false
	}
...
func (o *GetProfile200ResponseConfiguration) HasProfile() bool {
	if o != nil && !IsNil(o.Profile) {
		return true
	}
...
func (o *GetProfile200ResponseConfiguration) SetProfile(v ENUMPROPERTIESCONFIGURATIONPROPERTIESPROFILE) {
	o.Profile = &v
}
