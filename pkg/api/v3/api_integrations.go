...
type ApiCreateazureBoardsIntegrationRequest struct {
	ctx                                 context.Context
	ApiService                          *IntegrationsAPIService
	createazureBoardsIntegrationRequest *CreateazureBoardsIntegrationRequest
}

func (r ApiCreateazureBoardsIntegrationRequest) CreateazureBoardsIntegrationRequest(createazureBoardsIntegrationRequest CreateazureBoardsIntegrationRequest) ApiCreateazureBoardsIntegrationRequest {
	r.createazureBoardsIntegrationRequest = &createazureBoardsIntegrationRequest
	return r
}

func (r ApiCreateazureBoardsIntegrationRequest) Execute() (*CreateakamaiIntegration200Response, *http.Response, error) {
	return r.ApiService.CreateazureBoardsIntegrationExecute(r)
}

/*
CreateazureBoardsIntegration Create Azure Boards integrations.

Create a Azure Boards integration.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiCreateazureBoardsIntegrationRequest
*/
func (a *IntegrationsAPIService) CreateazureBoardsIntegration(ctx context.Context) ApiCreateazureBoardsIntegrationRequest {
	return ApiCreateazureBoardsIntegrationRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return CreateakamaiIntegration200Response
func (a *IntegrationsAPIService) CreateazureBoardsIntegrationExecute(r ApiCreateazureBoardsIntegrationRequest) (*CreateakamaiIntegration200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsAPIService.CreateazureBoardsIntegration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/integrations/azure-boards"
	...
	// body params
	localVarPostBody = r.createazureBoardsIntegrationRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
type ApiDeleteazureBoardsIntegrationRequest struct {
	ctx        context.Context
	ApiService *IntegrationsAPIService
	id         string
}

func (r ApiDeleteazureBoardsIntegrationRequest) Execute() (*CreateakamaiIntegration200Response, *http.Response, error) {
	return r.ApiService.DeleteazureBoardsIntegrationExecute(r)
}

/*
DeleteazureBoardsIntegration Delete Azure Boards integration.

Delete a Azure Boards integration.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The integration ID
	@return ApiDeleteazureBoardsIntegrationRequest
*/
func (a *IntegrationsAPIService) DeleteazureBoardsIntegration(ctx context.Context, id string) ApiDeleteazureBoardsIntegrationRequest {
	return ApiDeleteazureBoardsIntegrationRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return CreateakamaiIntegration200Response
func (a *IntegrationsAPIService) DeleteazureBoardsIntegrationExecute(r ApiDeleteazureBoardsIntegrationRequest) (*CreateakamaiIntegration200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodDelete
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsAPIService.DeleteazureBoardsIntegration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/integrations/azure-boards/{id}"
	localVarPath = strings.Replace(localVarPath, "{"+"id"+"}", url.PathEscape(parameterValueToString(r.id, "id")), -1)
...
Delete a Bitbucket integration.
...
Delete a Cloudflare integration.
...
Delete a Custom Integration integration.
...
Delete a Kubernetes integration.
...
type ApiGetazureBoardsIntegrationRequest struct {
	ctx        context.Context
	ApiService *IntegrationsAPIService
	id         string
}

func (r ApiGetazureBoardsIntegrationRequest) Execute() (*CreateakamaiIntegration200Response, *http.Response, error) {
	return r.ApiService.GetazureBoardsIntegrationExecute(r)
}

/*
GetazureBoardsIntegration Get Azure Boards integration.

Get a Azure Boards integration.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The integration ID
	@return ApiGetazureBoardsIntegrationRequest
*/
func (a *IntegrationsAPIService) GetazureBoardsIntegration(ctx context.Context, id string) ApiGetazureBoardsIntegrationRequest {
	return ApiGetazureBoardsIntegrationRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return CreateakamaiIntegration200Response
func (a *IntegrationsAPIService) GetazureBoardsIntegrationExecute(r ApiGetazureBoardsIntegrationRequest) (*CreateakamaiIntegration200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsAPIService.GetazureBoardsIntegration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiListazureBoardsIntegrationsRequest struct {
	ctx           context.Context
	ApiService    *IntegrationsAPIService
	cursor        *string
	size          *int
...
// The cursor to start the pagination from. Returned by the previous page response. If not provided, the first page will be returned.
func (r ApiListazureBoardsIntegrationsRequest) Cursor(cursor string) ApiListazureBoardsIntegrationsRequest {
	r.cursor = &cursor
	return r
}

// The number of items to return per page
func (r ApiListazureBoardsIntegrationsRequest) Size(size int) ApiListazureBoardsIntegrationsRequest {
	r.size = &size
	return r
}

// The type to sort by
func (r ApiListazureBoardsIntegrationsRequest) SortType(sortType string) ApiListazureBoardsIntegrationsRequest {
	r.sortType = &sortType
	return r
}

// The direction to sort by
func (r ApiListazureBoardsIntegrationsRequest) SortDirection(sortDirection string) ApiListazureBoardsIntegrationsRequest {
	r.sortDirection = &sortDirection
	return r
}

// Filter by project IDs
func (r ApiListazureBoardsIntegrationsRequest) ProjectIds(projectIds []string) ApiListazureBoardsIntegrationsRequest {
	r.projectIds = &projectIds
	return r
}

// Filter by integration IDs
func (r ApiListazureBoardsIntegrationsRequest) Ids(ids string) ApiListazureBoardsIntegrationsRequest {
	r.ids = &ids
	return r
}

// Filter by location IDs
func (r ApiListazureBoardsIntegrationsRequest) LocationIds(locationIds []string) ApiListazureBoardsIntegrationsRequest {
	r.locationIds = &locationIds
	return r
}

// Search term to filter integrations by name or description
func (r ApiListazureBoardsIntegrationsRequest) Search(search string) ApiListazureBoardsIntegrationsRequest {
	r.search = &search
	return r
}

func (r ApiListazureBoardsIntegrationsRequest) Execute() (*ListIntegrations200Response, *http.Response, error) {
	return r.ApiService.ListazureBoardsIntegrationsExecute(r)
}

/*
ListazureBoardsIntegrations List Azure Boards integrations.

List and search Azure Boards integrations of the organization.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@return ApiListazureBoardsIntegrationsRequest
*/
func (a *IntegrationsAPIService) ListazureBoardsIntegrations(ctx context.Context) ApiListazureBoardsIntegrationsRequest {
	return ApiListazureBoardsIntegrationsRequest{
		ApiService: a,
		ctx:        ctx,
	}
...
//
//	@return ListIntegrations200Response
func (a *IntegrationsAPIService) ListazureBoardsIntegrationsExecute(r ApiListazureBoardsIntegrationsRequest) (*ListIntegrations200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodGet
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsAPIService.ListazureBoardsIntegrations")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
...
type ApiUpdateazureBoardsIntegrationRequest struct {
	ctx                                 context.Context
	ApiService                          *IntegrationsAPIService
	id                                  string
	updateazureBoardsIntegrationRequest *UpdateazureBoardsIntegrationRequest
}

func (r ApiUpdateazureBoardsIntegrationRequest) UpdateazureBoardsIntegrationRequest(updateazureBoardsIntegrationRequest UpdateazureBoardsIntegrationRequest) ApiUpdateazureBoardsIntegrationRequest {
	r.updateazureBoardsIntegrationRequest = &updateazureBoardsIntegrationRequest
	return r
}

func (r ApiUpdateazureBoardsIntegrationRequest) Execute() (*CreateakamaiIntegration200Response, *http.Response, error) {
	return r.ApiService.UpdateazureBoardsIntegrationExecute(r)
}

/*
UpdateazureBoardsIntegration Update Azure Boards integration.

Update a Azure Boards integration.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param id The integration ID
	@return ApiUpdateazureBoardsIntegrationRequest
*/
func (a *IntegrationsAPIService) UpdateazureBoardsIntegration(ctx context.Context, id string) ApiUpdateazureBoardsIntegrationRequest {
	return ApiUpdateazureBoardsIntegrationRequest{
		ApiService: a,
		ctx:        ctx,
		id:         id,
...
//
//	@return CreateakamaiIntegration200Response
func (a *IntegrationsAPIService) UpdateazureBoardsIntegrationExecute(r ApiUpdateazureBoardsIntegrationRequest) (*CreateakamaiIntegration200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPut
		localVarPostBody    interface{}
		formFiles           []formFile
	...
	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IntegrationsAPIService.UpdateazureBoardsIntegration")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}
	...
	// body params
	localVarPostBody = r.updateazureBoardsIntegrationRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
