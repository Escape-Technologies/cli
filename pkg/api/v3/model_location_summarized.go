...
func (o *LocationSummarized) GetLastSeenAt() string {
...
// and a boolean to check if the value has been set.
func (o *LocationSummarized) GetLastSeenAtOk() (*string, bool) {
	if o == nil || IsNil(o.LastSeenAt) {
		return nil, false
	}
...
func (o *LocationSummarized) HasLastSeenAt() bool {
	if o != nil && !IsNil(o.LastSeenAt) {
		return true
	}
...
func (o *LocationSummarized) SetLastSeenAt(v string) {
	o.LastSeenAt = &v
}
