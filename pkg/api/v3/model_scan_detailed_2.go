...
// checks if the ScanDetailed2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScanDetailed2{}

// ScanDetailed2 Deprecated: identical to `lastScan`. Prefer `lastScan`.
type ScanDetailed2 struct {
	// The id of the scan
	Id string `json:"id"`
...
// NewScanDetailed2 instantiates a new ScanDetailed2 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScanDetailed2(id string, status string, createdAt string, updatedAt string, duration float32, progressRatio float32, initiator string, kind string, profileId string, organizationId string, links ScanDetailedLinks) *ScanDetailed2 {
	this := ScanDetailed2{}
	this.Id = id
	this.Status = status
...
// NewScanDetailed2WithDefaults instantiates a new ScanDetailed2 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScanDetailed2WithDefaults() *ScanDetailed2 {
	this := ScanDetailed2{}
	return &this
}

// GetId returns the Id field value
func (o *ScanDetailed2) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ScanDetailed2) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ScanDetailed2) SetId(v string) {
	o.Id = v
}

// GetStatus returns the Status field value
func (o *ScanDetailed2) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetStatus(v string) {
	o.Status = v
}

// GetCreatedAt returns the CreatedAt field value
func (o *ScanDetailed2) GetCreatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetCreatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetCreatedAt(v string) {
	o.CreatedAt = v
}

// GetUpdatedAt returns the UpdatedAt field value
func (o *ScanDetailed2) GetUpdatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetUpdatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetUpdatedAt(v string) {
	o.UpdatedAt = v
}

// GetFinishedAt returns the FinishedAt field value if set, zero value otherwise.
func (o *ScanDetailed2) GetFinishedAt() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetFinishedAtOk() (*string, bool) {
	if o == nil || IsNil(o.FinishedAt) {
		return nil, false
	}
...
func (o *ScanDetailed2) HasFinishedAt() bool {
	if o != nil && !IsNil(o.FinishedAt) {
		return true
	}
...
func (o *ScanDetailed2) SetFinishedAt(v string) {
	o.FinishedAt = &v
}

// GetScore returns the Score field value if set, zero value otherwise.
func (o *ScanDetailed2) GetScore() float32 {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetScoreOk() (*float32, bool) {
	if o == nil || IsNil(o.Score) {
		return nil, false
	}
	return o.Score, true
...
func (o *ScanDetailed2) HasScore() bool {
	if o != nil && !IsNil(o.Score) {
		return true
	}
...
func (o *ScanDetailed2) SetScore(v float32) {
	o.Score = &v
}

// GetCoverage returns the Coverage field value if set, zero value otherwise.
func (o *ScanDetailed2) GetCoverage() float32 {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetCoverageOk() (*float32, bool) {
	if o == nil || IsNil(o.Coverage) {
		return nil, false
	}
...
func (o *ScanDetailed2) HasCoverage() bool {
	if o != nil && !IsNil(o.Coverage) {
		return true
	}
...
func (o *ScanDetailed2) SetCoverage(v float32) {
	o.Coverage = &v
}

// GetDuration returns the Duration field value
func (o *ScanDetailed2) GetDuration() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetDurationOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetDuration(v float32) {
	o.Duration = v
}

// GetProgressRatio returns the ProgressRatio field value
func (o *ScanDetailed2) GetProgressRatio() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetProgressRatioOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetProgressRatio(v float32) {
	o.ProgressRatio = v
}

// GetInitiator returns the Initiator field value
func (o *ScanDetailed2) GetInitiator() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetInitiatorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetInitiator(v string) {
	o.Initiator = v
}

// GetKind returns the Kind field value
func (o *ScanDetailed2) GetKind() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Kind, true
...
func (o *ScanDetailed2) SetKind(v string) {
	o.Kind = v
}

// GetProfileId returns the ProfileId field value
func (o *ScanDetailed2) GetProfileId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetProfileIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetProfileId(v string) {
	o.ProfileId = v
}

// GetOrganizationId returns the OrganizationId field value
func (o *ScanDetailed2) GetOrganizationId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetOrganizationIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed2) SetOrganizationId(v string) {
	o.OrganizationId = v
}

// GetCommitHash returns the CommitHash field value if set, zero value otherwise.
func (o *ScanDetailed2) GetCommitHash() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetCommitHashOk() (*string, bool) {
	if o == nil || IsNil(o.CommitHash) {
		return nil, false
	}
...
func (o *ScanDetailed2) HasCommitHash() bool {
	if o != nil && !IsNil(o.CommitHash) {
		return true
	}
...
func (o *ScanDetailed2) SetCommitHash(v string) {
	o.CommitHash = &v
}

// GetCommitBranch returns the CommitBranch field value if set, zero value otherwise.
func (o *ScanDetailed2) GetCommitBranch() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetCommitBranchOk() (*string, bool) {
	if o == nil || IsNil(o.CommitBranch) {
		return nil, false
	}
...
func (o *ScanDetailed2) HasCommitBranch() bool {
	if o != nil && !IsNil(o.CommitBranch) {
		return true
	}
...
func (o *ScanDetailed2) SetCommitBranch(v string) {
	o.CommitBranch = &v
}

// GetCommitAuthor returns the CommitAuthor field value if set, zero value otherwise.
func (o *ScanDetailed2) GetCommitAuthor() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetCommitAuthorOk() (*string, bool) {
	if o == nil || IsNil(o.CommitAuthor) {
		return nil, false
	}
...
func (o *ScanDetailed2) HasCommitAuthor() bool {
	if o != nil && !IsNil(o.CommitAuthor) {
		return true
	}
...
func (o *ScanDetailed2) SetCommitAuthor(v string) {
	o.CommitAuthor = &v
}

// GetCommitLink returns the CommitLink field value if set, zero value otherwise.
func (o *ScanDetailed2) GetCommitLink() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetCommitLinkOk() (*string, bool) {
	if o == nil || IsNil(o.CommitLink) {
		return nil, false
	}
...
func (o *ScanDetailed2) HasCommitLink() bool {
	if o != nil && !IsNil(o.CommitLink) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetCommitAuthorProfilePictureLinkOk() (*string, bool) {
	if o == nil || IsNil(o.CommitAuthorProfilePictureLink) {
		return nil, false
	}
...
func (o *ScanDetailed2) HasCommitAuthorProfilePictureLink() bool {
	if o != nil && !IsNil(o.CommitAuthorProfilePictureLink) {
		return true
	}
...
func (o *ScanDetailed2) SetCommitAuthorProfilePictureLink(v string) {
	o.CommitAuthorProfilePictureLink = &v
}

// GetLinks returns the Links field value
func (o *ScanDetailed2) GetLinks() ScanDetailedLinks {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed2) GetLinksOk() (*ScanDetailedLinks, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Links, true
...
func (o *ScanDetailed2) SetLinks(v ScanDetailedLinks) {
	o.Links = v
}
...
func (o ScanDetailed2) ToMap() (map[string]interface{}, error) {
...
func (o *ScanDetailed2) UnmarshalJSON(data []byte) (err error) {
	...
	varScanDetailed2 := _ScanDetailed2{}

	err = json.Unmarshal(data, &varScanDetailed2)

	if err != nil {
		return err
	}

	*o = ScanDetailed2(varScanDetailed2)
...
type NullableScanDetailed2 struct {
	value *ScanDetailed2
	isSet bool
}

func (v NullableScanDetailed2) Get() *ScanDetailed2 {
	return v.value
}

func (v *NullableScanDetailed2) Set(val *ScanDetailed2) {
	v.value = val
	v.isSet = true
}

func (v NullableScanDetailed2) IsSet() bool {
	return v.isSet
}

func (v *NullableScanDetailed2) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScanDetailed2(val *ScanDetailed2) *NullableScanDetailed2 {
	return &NullableScanDetailed2{value: val, isSet: true}
}

func (v NullableScanDetailed2) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScanDetailed2) UnmarshalJSON(src []byte) error {
	v.isSet = true
