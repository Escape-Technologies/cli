...
// checks if the ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12{}
...
// NewProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 instantiates a new ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 object
...
// NewProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12WithDefaults instantiates a new ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12WithDefaults() *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 {
	this := ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12{}
	return &this
}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetUsers() []ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12UsersInner {
	if o == nil {
		var ret []ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12UsersInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetUsersOk() ([]ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12UsersInner, bool) {
	if o == nil {
		return nil, false
	}
	return o.Users, true
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) SetUsers(v []ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12UsersInner) {
	o.Users = v
}

// GetLoginUrl returns the LoginUrl field value
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetLoginUrl() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetLoginUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) SetLoginUrl(v string) {
	o.LoginUrl = v
}

// GetStealthMode returns the StealthMode field value if set, zero value otherwise.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetStealthMode() bool {
...
// and a boolean to check if the value has been set.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetStealthModeOk() (*bool, bool) {
	if o == nil || IsNil(o.StealthMode) {
		return nil, false
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) HasStealthMode() bool {
	if o != nil && !IsNil(o.StealthMode) {
		return true
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) SetStealthMode(v bool) {
	o.StealthMode = &v
}

// GetExtractions returns the Extractions field value if set, zero value otherwise.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetExtractions() []ProfileDetailedConfigurationAuthenticationProceduresInnerOperationsInnerOneOf1ExtractionsAnyOfInner {
...
// and a boolean to check if the value has been set.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetExtractionsOk() ([]ProfileDetailedConfigurationAuthenticationProceduresInnerOperationsInnerOneOf1ExtractionsAnyOfInner, bool) {
	if o == nil || IsNil(o.Extractions) {
		return nil, false
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) HasExtractions() bool {
	if o != nil && !IsNil(o.Extractions) {
		return true
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) SetExtractions(v []ProfileDetailedConfigurationAuthenticationProceduresInnerOperationsInnerOneOf1ExtractionsAnyOfInner) {
	o.Extractions = v
}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) HasInjections() bool {
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) UnsetInjections() {
	o.Injections.Unset()
}

// GetAutoExtractionUrls returns the AutoExtractionUrls field value if set, zero value otherwise.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetAutoExtractionUrls() []string {
...
// and a boolean to check if the value has been set.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetAutoExtractionUrlsOk() ([]string, bool) {
	if o == nil || IsNil(o.AutoExtractionUrls) {
		return nil, false
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) HasAutoExtractionUrls() bool {
	if o != nil && !IsNil(o.AutoExtractionUrls) {
		return true
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) SetAutoExtractionUrls(v []string) {
	o.AutoExtractionUrls = v
}

// GetLoggedInDetectorText returns the LoggedInDetectorText field value if set, zero value otherwise.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetLoggedInDetectorText() string {
...
// and a boolean to check if the value has been set.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetLoggedInDetectorTextOk() (*string, bool) {
	if o == nil || IsNil(o.LoggedInDetectorText) {
		return nil, false
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) HasLoggedInDetectorText() bool {
	if o != nil && !IsNil(o.LoggedInDetectorText) {
		return true
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) SetLoggedInDetectorText(v string) {
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetLoggedInDetectorTimeout() float32 {
...
// and a boolean to check if the value has been set.
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) GetLoggedInDetectorTimeoutOk() (*float32, bool) {
	if o == nil || IsNil(o.LoggedInDetectorTimeout) {
		return nil, false
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) HasLoggedInDetectorTimeout() bool {
	if o != nil && !IsNil(o.LoggedInDetectorTimeout) {
		return true
	}
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) SetLoggedInDetectorTimeout(v float32) {
...
func (o ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) ToMap() (map[string]interface{}, error) {
...
func (o *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) UnmarshalJSON(data []byte) (err error) {
	...
	varProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 := _ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12{}

	err = json.Unmarshal(data, &varProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12)

	if err != nil {
		return err
	}

	*o = ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12(varProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12)
...
type NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 struct {
	value *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12
	isSet bool
}

func (v NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) Get() *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 {
	return v.value
}

func (v *NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) Set(val *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) {
	v.value = val
	v.isSet = true
}

func (v NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) IsSet() bool {
	return v.isSet
}

func (v *NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12(val *ProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) *NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12 {
	return &NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12{value: val, isSet: true}
}

func (v NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableProfileDetailedConfigurationAuthenticationPresetsInnerOneOf12) UnmarshalJSON(src []byte) error {
	v.isSet = true
