...
func NewListUsers200ResponseInner(id string, email string, createdAt time.Time, activatedAt NullableTime, roleBindings []ListProjects200ResponseDataInnerBindingsInner) *ListUsers200ResponseInner {
