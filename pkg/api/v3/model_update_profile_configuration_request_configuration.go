...
// Deprecated
func (o *UpdateProfileConfigurationRequestConfiguration) GetMaxDuration() float32 {
...
// and a boolean to check if the value has been set.
// Deprecated
func (o *UpdateProfileConfigurationRequestConfiguration) GetMaxDurationOk() (*float32, bool) {
	if o == nil || IsNil(o.MaxDuration) {
		return nil, false
	}
...
func (o *UpdateProfileConfigurationRequestConfiguration) HasMaxDuration() bool {
	if o != nil && !IsNil(o.MaxDuration) {
		return true
	}
...
// Deprecated
func (o *UpdateProfileConfigurationRequestConfiguration) SetMaxDuration(v float32) {
	o.MaxDuration = &v
}
