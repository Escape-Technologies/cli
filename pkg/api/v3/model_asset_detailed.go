...
func NewAssetDetailed(id string, class ENUMPROPERTIESDATAITEMSPROPERTIESEXTRAASSETSITEMSPROPERTIESCLASS, type_ ENUMPROPERTIESDATAITEMSPROPERTIESEXTRAASSETSITEMSPROPERTIESTYPE, name string, createdAt string, status ENUMPROPERTIESDATAITEMSPROPERTIESEXTRAASSETSITEMSPROPERTIESSTATUS, tags []Tag, risks []ENUMPROPERTIESDATAITEMSPROPERTIESASSETPROPERTIESRISKSITEMS, links AssetDetailedLinks) *AssetDetailed {
	this := AssetDetailed{}
	this.Id = id
	this.Class = class
	this.Type = type_
...
func (o *AssetDetailed) HasLastSeenAt() bool {
	if o != nil && !IsNil(o.LastSeenAt) {
		return true
	}
...
func (o *AssetDetailed) HasSchemaUrl() bool {
	if o != nil && !IsNil(o.SchemaUrl) {
		return true
	}
