...
type ListLocations200Response struct {
	...
	Data []LocationSummarized `json:"data"`
...
func NewListLocations200Response(data []LocationSummarized) *ListLocations200Response {
...
func (o *ListLocations200Response) HasNextCursor() bool {
	if o != nil && !IsNil(o.NextCursor) {
		return true
	}
...
func (o *ListLocations200Response) GetData() []LocationSummarized {
	if o == nil {
		var ret []LocationSummarized
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ListLocations200Response) GetDataOk() ([]LocationSummarized, bool) {
	if o == nil {
		return nil, false
	}
	return o.Data, true
...
func (o *ListLocations200Response) SetData(v []LocationSummarized) {
	o.Data = v
}
