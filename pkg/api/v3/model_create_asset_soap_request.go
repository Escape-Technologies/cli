...
// checks if the CreateAssetSOAPRequest type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateAssetSOAPRequest{}

// CreateAssetSOAPRequest struct for CreateAssetSOAPRequest
type CreateAssetSOAPRequest struct {
...
// NewCreateAssetSOAPRequest instantiates a new CreateAssetSOAPRequest object
...
// NewCreateAssetSOAPRequestWithDefaults instantiates a new CreateAssetSOAPRequest object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewCreateAssetSOAPRequestWithDefaults() *CreateAssetSOAPRequest {
	this := CreateAssetSOAPRequest{}
	return &this
}
...
func (o *CreateAssetSOAPRequest) HasProjectIds() bool {
	if o != nil && !IsNil(o.ProjectIds) {
		return true
	}
...
func (o *CreateAssetSOAPRequest) SetProjectIds(v []string) {
	o.ProjectIds = v
}
...
func (o *CreateAssetSOAPRequest) GetAssetClass() ENUMAPISERVICE {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetSOAPRequest) GetAssetClassOk() (*ENUMAPISERVICE, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateAssetSOAPRequest) SetAssetClass(v ENUMAPISERVICE) {
	o.AssetClass = v
}

// GetExtraMetadata returns the ExtraMetadata field value if set, zero value otherwise.
func (o *CreateAssetSOAPRequest) GetExtraMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetSOAPRequest) GetExtraMetadataOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.ExtraMetadata) {
...
func (o *CreateAssetSOAPRequest) HasExtraMetadata() bool {
	if o != nil && !IsNil(o.ExtraMetadata) {
		return true
	}
...
func (o *CreateAssetSOAPRequest) SetExtraMetadata(v map[string]interface{}) {
	o.ExtraMetadata = v
}
...
// and a boolean to check if the value has been set.
func (o *CreateAssetSOAPRequest) GetUrlOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Url, true
...
func (o *CreateAssetSOAPRequest) HasReachableVia() bool {
	if o != nil && !IsNil(o.ReachableVia) {
		return true
	}
...
func (o *CreateAssetSOAPRequest) SetReachableVia(v []string) {
	o.ReachableVia = v
}
...
func (o *CreateAssetSOAPRequest) HasIps() bool {
	if o != nil && !IsNil(o.Ips) {
		return true
	}
...
func (o *CreateAssetSOAPRequest) SetIps(v []string) {
	o.Ips = v
}
...
func (o *CreateAssetSOAPRequest) HasRegionCountryCodes() bool {
	if o != nil && !IsNil(o.RegionCountryCodes) {
		return true
	}
...
func (o *CreateAssetSOAPRequest) SetRegionCountryCodes(v []string) {
...
func (o *CreateAssetSOAPRequest) UnmarshalJSON(data []byte) (err error) {
	...
	varCreateAssetSOAPRequest := _CreateAssetSOAPRequest{}

	err = json.Unmarshal(data, &varCreateAssetSOAPRequest)

	if err != nil {
		return err
	}

	*o = CreateAssetSOAPRequest(varCreateAssetSOAPRequest)
...
type NullableCreateAssetSOAPRequest struct {
	value *CreateAssetSOAPRequest
	isSet bool
}

func (v NullableCreateAssetSOAPRequest) Get() *CreateAssetSOAPRequest {
	return v.value
}

func (v *NullableCreateAssetSOAPRequest) Set(val *CreateAssetSOAPRequest) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateAssetSOAPRequest) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateAssetSOAPRequest) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateAssetSOAPRequest(val *CreateAssetSOAPRequest) *NullableCreateAssetSOAPRequest {
	return &NullableCreateAssetSOAPRequest{value: val, isSet: true}
}

func (v NullableCreateAssetSOAPRequest) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateAssetSOAPRequest) UnmarshalJSON(src []byte) error {
	v.isSet = true
