...
func (o *CreateAssetComment200Response) GetComment() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetComment200Response) GetCommentOk() (*string, bool) {
	if o == nil || IsNil(o.Comment) {
		return nil, false
	}
...
func (o *CreateAssetComment200Response) HasComment() bool {
	if o != nil && !IsNil(o.Comment) {
		return true
	}
...
func (o *CreateAssetComment200Response) SetComment(v string) {
	o.Comment = &v
}
