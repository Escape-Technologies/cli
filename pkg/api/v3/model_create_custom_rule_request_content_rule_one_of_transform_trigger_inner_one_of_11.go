...
func (o *CreateCustomRuleRequestContentRuleOneOfTransformTriggerInnerOneOf11) SetUseExtractionNil() {
	o.UseExtraction.Set(nil)
}

// UnsetUseExtraction ensures that no value is present for UseExtraction, not even an explicit nil
func (o *CreateCustomRuleRequestContentRuleOneOfTransformTriggerInnerOneOf11) UnsetUseExtraction() {
...
func (o *CreateCustomRuleRequestContentRuleOneOfTransformTriggerInnerOneOf11) SetJqNil() {
	o.Jq.Set(nil)
}

// UnsetJq ensures that no value is present for Jq, not even an explicit nil
func (o *CreateCustomRuleRequestContentRuleOneOfTransformTriggerInnerOneOf11) UnsetJq() {
	o.Jq.Unset()
}
