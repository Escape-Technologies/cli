...
// checks if the ScanDetailed3 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScanDetailed3{}

// ScanDetailed3 Deprecated: identical to `lastSuccessfulScan`. Prefer `lastSuccessfulScan`.
type ScanDetailed3 struct {
	// The id of the scan
	Id string `json:"id"`
...
type _ScanDetailed3 ScanDetailed3

// NewScanDetailed3 instantiates a new ScanDetailed3 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScanDetailed3(id string, status string, createdAt string, updatedAt string, duration float32, progressRatio float32, initiator string, kind string, profileId string, organizationId string, links ScanDetailedLinks) *ScanDetailed3 {
	this := ScanDetailed3{}
	this.Id = id
	this.Status = status
...
// NewScanDetailed3WithDefaults instantiates a new ScanDetailed3 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScanDetailed3WithDefaults() *ScanDetailed3 {
	this := ScanDetailed3{}
	return &this
}

// GetId returns the Id field value
func (o *ScanDetailed3) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ScanDetailed3) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ScanDetailed3) SetId(v string) {
	o.Id = v
}

// GetStatus returns the Status field value
func (o *ScanDetailed3) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetStatus(v string) {
	o.Status = v
}

// GetCreatedAt returns the CreatedAt field value
func (o *ScanDetailed3) GetCreatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetCreatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetCreatedAt(v string) {
	o.CreatedAt = v
}

// GetUpdatedAt returns the UpdatedAt field value
func (o *ScanDetailed3) GetUpdatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetUpdatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetUpdatedAt(v string) {
	o.UpdatedAt = v
}

// GetFinishedAt returns the FinishedAt field value if set, zero value otherwise.
func (o *ScanDetailed3) GetFinishedAt() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetFinishedAtOk() (*string, bool) {
	if o == nil || IsNil(o.FinishedAt) {
		return nil, false
	}
...
func (o *ScanDetailed3) HasFinishedAt() bool {
	if o != nil && !IsNil(o.FinishedAt) {
		return true
	}
...
func (o *ScanDetailed3) SetFinishedAt(v string) {
	o.FinishedAt = &v
}

// GetScore returns the Score field value if set, zero value otherwise.
func (o *ScanDetailed3) GetScore() float32 {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetScoreOk() (*float32, bool) {
	if o == nil || IsNil(o.Score) {
		return nil, false
	}
	return o.Score, true
...
func (o *ScanDetailed3) HasScore() bool {
	if o != nil && !IsNil(o.Score) {
		return true
	}
...
func (o *ScanDetailed3) SetScore(v float32) {
	o.Score = &v
}

// GetCoverage returns the Coverage field value if set, zero value otherwise.
func (o *ScanDetailed3) GetCoverage() float32 {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetCoverageOk() (*float32, bool) {
	if o == nil || IsNil(o.Coverage) {
		return nil, false
	}
...
func (o *ScanDetailed3) HasCoverage() bool {
	if o != nil && !IsNil(o.Coverage) {
		return true
	}
...
func (o *ScanDetailed3) SetCoverage(v float32) {
	o.Coverage = &v
}

// GetDuration returns the Duration field value
func (o *ScanDetailed3) GetDuration() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetDurationOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetDuration(v float32) {
	o.Duration = v
}

// GetProgressRatio returns the ProgressRatio field value
func (o *ScanDetailed3) GetProgressRatio() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetProgressRatioOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetProgressRatio(v float32) {
	o.ProgressRatio = v
}

// GetInitiator returns the Initiator field value
func (o *ScanDetailed3) GetInitiator() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetInitiatorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetInitiator(v string) {
	o.Initiator = v
}

// GetKind returns the Kind field value
func (o *ScanDetailed3) GetKind() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Kind, true
...
func (o *ScanDetailed3) SetKind(v string) {
	o.Kind = v
}

// GetProfileId returns the ProfileId field value
func (o *ScanDetailed3) GetProfileId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetProfileIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetProfileId(v string) {
	o.ProfileId = v
}

// GetOrganizationId returns the OrganizationId field value
func (o *ScanDetailed3) GetOrganizationId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetOrganizationIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed3) SetOrganizationId(v string) {
	o.OrganizationId = v
}

// GetCommitHash returns the CommitHash field value if set, zero value otherwise.
func (o *ScanDetailed3) GetCommitHash() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetCommitHashOk() (*string, bool) {
	if o == nil || IsNil(o.CommitHash) {
		return nil, false
	}
...
func (o *ScanDetailed3) HasCommitHash() bool {
	if o != nil && !IsNil(o.CommitHash) {
		return true
	}
...
func (o *ScanDetailed3) SetCommitHash(v string) {
	o.CommitHash = &v
}

// GetCommitBranch returns the CommitBranch field value if set, zero value otherwise.
func (o *ScanDetailed3) GetCommitBranch() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetCommitBranchOk() (*string, bool) {
	if o == nil || IsNil(o.CommitBranch) {
		return nil, false
	}
...
func (o *ScanDetailed3) HasCommitBranch() bool {
	if o != nil && !IsNil(o.CommitBranch) {
		return true
	}
...
func (o *ScanDetailed3) SetCommitBranch(v string) {
	o.CommitBranch = &v
}

// GetCommitAuthor returns the CommitAuthor field value if set, zero value otherwise.
func (o *ScanDetailed3) GetCommitAuthor() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetCommitAuthorOk() (*string, bool) {
	if o == nil || IsNil(o.CommitAuthor) {
		return nil, false
	}
...
func (o *ScanDetailed3) HasCommitAuthor() bool {
	if o != nil && !IsNil(o.CommitAuthor) {
		return true
	}
...
func (o *ScanDetailed3) SetCommitAuthor(v string) {
	o.CommitAuthor = &v
}

// GetCommitLink returns the CommitLink field value if set, zero value otherwise.
func (o *ScanDetailed3) GetCommitLink() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetCommitLinkOk() (*string, bool) {
	if o == nil || IsNil(o.CommitLink) {
		return nil, false
	}
...
func (o *ScanDetailed3) HasCommitLink() bool {
	if o != nil && !IsNil(o.CommitLink) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetCommitAuthorProfilePictureLinkOk() (*string, bool) {
	if o == nil || IsNil(o.CommitAuthorProfilePictureLink) {
		return nil, false
	}
...
func (o *ScanDetailed3) HasCommitAuthorProfilePictureLink() bool {
	if o != nil && !IsNil(o.CommitAuthorProfilePictureLink) {
		return true
	}
...
func (o *ScanDetailed3) SetCommitAuthorProfilePictureLink(v string) {
	o.CommitAuthorProfilePictureLink = &v
}

// GetLinks returns the Links field value
func (o *ScanDetailed3) GetLinks() ScanDetailedLinks {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed3) GetLinksOk() (*ScanDetailedLinks, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Links, true
...
func (o *ScanDetailed3) SetLinks(v ScanDetailedLinks) {
	o.Links = v
}

func (o ScanDetailed3) MarshalJSON() ([]byte, error) {
...
func (o ScanDetailed3) ToMap() (map[string]interface{}, error) {
...
func (o *ScanDetailed3) UnmarshalJSON(data []byte) (err error) {
	...
	varScanDetailed3 := _ScanDetailed3{}

	err = json.Unmarshal(data, &varScanDetailed3)

	if err != nil {
		return err
	}

	*o = ScanDetailed3(varScanDetailed3)
...
type NullableScanDetailed3 struct {
	value *ScanDetailed3
	isSet bool
}

func (v NullableScanDetailed3) Get() *ScanDetailed3 {
	return v.value
}

func (v *NullableScanDetailed3) Set(val *ScanDetailed3) {
	v.value = val
	v.isSet = true
}

func (v NullableScanDetailed3) IsSet() bool {
	return v.isSet
}

func (v *NullableScanDetailed3) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScanDetailed3(val *ScanDetailed3) *NullableScanDetailed3 {
	return &NullableScanDetailed3{value: val, isSet: true}
}

func (v NullableScanDetailed3) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScanDetailed3) UnmarshalJSON(src []byte) error {
	v.isSet = true
