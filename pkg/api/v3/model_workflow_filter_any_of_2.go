...
func (o *WorkflowFilterAnyOf2) GetKinds() []ENUMPROPERTIESFILTERPROPERTIESSCANNERKINDSITEMS {
...
// and a boolean to check if the value has been set.
func (o *WorkflowFilterAnyOf2) GetKindsOk() ([]ENUMPROPERTIESFILTERPROPERTIESSCANNERKINDSITEMS, bool) {
	if o == nil || IsNil(o.Kinds) {
		return nil, false
	}
	return o.Kinds, true
...
// SetKinds gets a reference to the given []ENUMPROPERTIESFILTERPROPERTIESSCANNERKINDSITEMS and assigns it to the Kinds field.
func (o *WorkflowFilterAnyOf2) SetKinds(v []ENUMPROPERTIESFILTERPROPERTIESSCANNERKINDSITEMS) {
	o.Kinds = v
}
