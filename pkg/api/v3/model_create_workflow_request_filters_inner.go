...
func (dst *CreateWorkflowRequestFiltersInner) UnmarshalJSON(data []byte) error {
	...
	return fmt.Errorf("data failed to match schemas in anyOf(CreateWorkflowRequestFiltersInner)")
}

// Marshal data from the first non-nil pointers in the struct to JSON
func (src CreateWorkflowRequestFiltersInner) MarshalJSON() ([]byte, error) {
...
func (v NullableCreateWorkflowRequestFiltersInner) Get() *CreateWorkflowRequestFiltersInner {
	return v.value
}

func (v *NullableCreateWorkflowRequestFiltersInner) Set(val *CreateWorkflowRequestFiltersInner) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateWorkflowRequestFiltersInner) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateWorkflowRequestFiltersInner) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateWorkflowRequestFiltersInner(val *CreateWorkflowRequestFiltersInner) *NullableCreateWorkflowRequestFiltersInner {
	return &NullableCreateWorkflowRequestFiltersInner{value: val, isSet: true}
}

func (v NullableCreateWorkflowRequestFiltersInner) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateWorkflowRequestFiltersInner) UnmarshalJSON(src []byte) error {
	v.isSet = true
