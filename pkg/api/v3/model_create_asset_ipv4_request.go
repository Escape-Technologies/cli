...
func (o *CreateAssetIPV4Request) GetParents() []CreateAssetDNSRequestParentsInner {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetIPV4Request) GetParentsOk() ([]CreateAssetDNSRequestParentsInner, bool) {
	if o == nil || IsNil(o.Parents) {
		return nil, false
	}
...
func (o *CreateAssetIPV4Request) HasParents() bool {
	if o != nil && !IsNil(o.Parents) {
		return true
	}
...
func (o *CreateAssetIPV4Request) SetParents(v []CreateAssetDNSRequestParentsInner) {
	o.Parents = v
}

// GetChildrens returns the Childrens field value if set, zero value otherwise.
func (o *CreateAssetIPV4Request) GetChildrens() []CreateAssetDNSRequestParentsInner {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetIPV4Request) GetChildrensOk() ([]CreateAssetDNSRequestParentsInner, bool) {
	if o == nil || IsNil(o.Childrens) {
		return nil, false
	}
...
func (o *CreateAssetIPV4Request) HasChildrens() bool {
	if o != nil && !IsNil(o.Childrens) {
		return true
	}
...
func (o *CreateAssetIPV4Request) SetChildrens(v []CreateAssetDNSRequestParentsInner) {
	o.Childrens = v
}
