...
func (r ApiTriggerAsmScansRequest) TriggerAsmScansRequest(triggerAsmScansRequest TriggerAsmScansRequest) ApiTriggerAsmScansRequest {
	r.triggerAsmScansRequest = &triggerAsmScansRequest
	return r
}

func (r ApiTriggerAsmScansRequest) Execute() (*TriggerAsmScans200Response, *http.Response, error) {
	return r.ApiService.TriggerAsmScansExecute(r)
}
...
func (a *AsmAPIService) TriggerAsmScansExecute(r ApiTriggerAsmScansRequest) (*TriggerAsmScans200Response, *http.Response, error) {
	...
	localVarPath := localBasePath + "/asm/scans"
	...
	// body params
	localVarPostBody = r.triggerAsmScansRequest
	if r.ctx != nil {
