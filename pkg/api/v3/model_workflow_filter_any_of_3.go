...
func (o *WorkflowFilterAnyOf3) GetKinds() []ENUMPROPERTIESFILTERPROPERTIESSCANNERKINDSITEMS {
...
// and a boolean to check if the value has been set.
func (o *WorkflowFilterAnyOf3) GetKindsOk() ([]ENUMPROPERTIESFILTERPROPERTIESSCANNERKINDSITEMS, bool) {
	if o == nil || IsNil(o.Kinds) {
		return nil, false
	}
	return o.Kinds, true
...
func (o *WorkflowFilterAnyOf3) SetKinds(v []ENUMPROPERTIESFILTERPROPERTIESSCANNERKINDSITEMS) {
	o.Kinds = v
}
