...
func NewCreateAssetPOSTMANORGANIZATIONRequest(assetClass ENUMDEVTOOLS, assetType ENUMPOSTMANORGANIZATION, immutableKey string, apiKey string) *CreateAssetPOSTMANORGANIZATIONRequest {
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetWizProviderId() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetWizProviderIdOk() (*string, bool) {
	if o == nil || IsNil(o.WizProviderId) {
		return nil, false
	}
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) HasWizProviderId() bool {
	if o != nil && !IsNil(o.WizProviderId) {
		return true
	}
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) SetWizProviderId(v string) {
	o.WizProviderId = &v
}

// GetWizCloudPlatform returns the WizCloudPlatform field value if set, zero value otherwise.
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetWizCloudPlatform() string {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetWizCloudPlatformOk() (*string, bool) {
	if o == nil || IsNil(o.WizCloudPlatform) {
		return nil, false
	}
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) HasWizCloudPlatform() bool {
	if o != nil && !IsNil(o.WizCloudPlatform) {
		return true
	}
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) SetWizCloudPlatform(v string) {
	o.WizCloudPlatform = &v
}

// GetExtraMetadata returns the ExtraMetadata field value if set, zero value otherwise.
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetExtraMetadata() map[string]interface{} {
...
// and a boolean to check if the value has been set.
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetExtraMetadataOk() (map[string]interface{}, bool) {
	if o == nil || IsNil(o.ExtraMetadata) {
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) HasExtraMetadata() bool {
	if o != nil && !IsNil(o.ExtraMetadata) {
		return true
	}
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) SetExtraMetadata(v map[string]interface{}) {
	o.ExtraMetadata = v
}
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetImmutableKey() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateAssetPOSTMANORGANIZATIONRequest) GetImmutableKeyOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateAssetPOSTMANORGANIZATIONRequest) SetImmutableKey(v string) {
	o.ImmutableKey = v
}
