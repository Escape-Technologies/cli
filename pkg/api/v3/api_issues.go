...
*/
func (a *IssuesAPIService) CreateIssueComment(ctx context.Context, issueId string) ApiCreateIssueCommentRequest {
	return ApiCreateIssueCommentRequest{
		ApiService: a,
		ctx:        ctx,
		issueId:    issueId,
...
func (r ApiGetIssueFunnelRequest) ProjectIds(projectIds UpdateProfileRequestExtraAssetIds) ApiGetIssueFunnelRequest {
...
type ApiGetIssueTrendsRequest struct {
	...
	before         *string
	interval       *string
	applicationIds *UpdateProfileRequestExtraAssetIds
	projectIds     *UpdateProfileRequestExtraAssetIds
}
...
func (r ApiGetIssueTrendsRequest) ApplicationIds(applicationIds UpdateProfileRequestExtraAssetIds) ApiGetIssueTrendsRequest {
	r.applicationIds = &applicationIds
	return r
}

// Filter by project IDs
func (r ApiGetIssueTrendsRequest) ProjectIds(projectIds UpdateProfileRequestExtraAssetIds) ApiGetIssueTrendsRequest {
	r.projectIds = &projectIds
	return r
}
...
type ApiListIssuesRequest struct {
	...
	domains       *string
	ids           *string
	names         *UpdateProfileRequestExtraAssetIds
	scanIds       *string
	tagIds        *string
	search        *string
	jiraTicket    *string
...
func (r ApiListIssuesRequest) Names(names UpdateProfileRequestExtraAssetIds) ApiListIssuesRequest {
	r.names = &names
	return r
}
...
type ApiTriggerIssueManualWorkflowRequest struct {
	ctx                               context.Context
	ApiService                        *IssuesAPIService
	issueId                           string
	triggerIssueManualWorkflowRequest *TriggerIssueManualWorkflowRequest
}

func (r ApiTriggerIssueManualWorkflowRequest) TriggerIssueManualWorkflowRequest(triggerIssueManualWorkflowRequest TriggerIssueManualWorkflowRequest) ApiTriggerIssueManualWorkflowRequest {
	r.triggerIssueManualWorkflowRequest = &triggerIssueManualWorkflowRequest
	return r
}

func (r ApiTriggerIssueManualWorkflowRequest) Execute() (*TriggerIssueManualWorkflow200Response, *http.Response, error) {
	return r.ApiService.TriggerIssueManualWorkflowExecute(r)
}

/*
TriggerIssueManualWorkflow Trigger a manual workflow on an issue

Trigger a manual workflow for a specific issue, such as exporting the issue to Jira.

	@param ctx context.Context - for authentication, logging, cancellation, deadlines, tracing, etc. Passed from http.Request or context.Background().
	@param issueId The issue ID
	@return ApiTriggerIssueManualWorkflowRequest
*/
func (a *IssuesAPIService) TriggerIssueManualWorkflow(ctx context.Context, issueId string) ApiTriggerIssueManualWorkflowRequest {
	return ApiTriggerIssueManualWorkflowRequest{
		ApiService: a,
		ctx:        ctx,
		issueId:    issueId,
...
// Execute executes the request
//
//	@return TriggerIssueManualWorkflow200Response
func (a *IssuesAPIService) TriggerIssueManualWorkflowExecute(r ApiTriggerIssueManualWorkflowRequest) (*TriggerIssueManualWorkflow200Response, *http.Response, error) {
	var (
		localVarHTTPMethod  = http.MethodPost
		localVarPostBody    interface{}
		formFiles           []formFile
		localVarReturnValue *TriggerIssueManualWorkflow200Response
	)

	localBasePath, err := a.client.cfg.ServerURLWithContext(r.ctx, "IssuesAPIService.TriggerIssueManualWorkflow")
	if err != nil {
		return localVarReturnValue, nil, &GenericOpenAPIError{error: err.Error()}
	}

	localVarPath := localBasePath + "/issues/{issueId}/manual-workflow"
	localVarPath = strings.Replace(localVarPath, "{"+"issueId"+"}", url.PathEscape(parameterValueToString(r.issueId, "issueId")), -1)
	...
	// body params
	localVarPostBody = r.triggerIssueManualWorkflowRequest
	if r.ctx != nil {
		// API Key Authentication
		if auth, ok := r.ctx.Value(ContextAPIKeys).(map[string]APIKey); ok {
			if apiKey, ok := auth["apiKey"]; ok {
...
func (r ApiUpdateIssueRequest) Execute() (*BulkUpdateIssues200Response, *http.Response, error) {
...
//
//	@return BulkUpdateIssues200Response
func (a *IssuesAPIService) UpdateIssueExecute(r ApiUpdateIssueRequest) (*BulkUpdateIssues200Response, *http.Response, error) {
	var (
