...
func NewCreateAssetGCPPROJECTRequest(assetClass string, assetType string, authProviderX509CertUrl string, authUri string, clientEmail string, clientId string, clientX509CertUrl string, privateKey string, privateKeyId string, tokenUri string, universeDomain string, projectId string) *CreateAssetGCPPROJECTRequest {
...
func (o *CreateAssetGCPPROJECTRequest) GetAssetClass() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *CreateAssetGCPPROJECTRequest) GetAssetClassOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateAssetGCPPROJECTRequest) SetAssetClass(v string) {
	o.AssetClass = v
}

// GetAssetType returns the AssetType field value
func (o *CreateAssetGCPPROJECTRequest) GetAssetType() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *CreateAssetGCPPROJECTRequest) GetAssetTypeOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateAssetGCPPROJECTRequest) SetAssetType(v string) {
	o.AssetType = v
}
