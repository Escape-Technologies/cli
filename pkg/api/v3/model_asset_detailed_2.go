...
func (o *AssetDetailed2) GetProjectIds() []string {
	if o == nil {
		var ret []string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *AssetDetailed2) GetProjectIdsOk() ([]string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *AssetDetailed2) SetProjectIds(v []string) {
	o.ProjectIds = v
}
...
func (o *AssetDetailed2) GetTechnology() AssetTechnologyDetailed {
...
// and a boolean to check if the value has been set.
func (o *AssetDetailed2) GetTechnologyOk() (*AssetTechnologyDetailed, bool) {
	if o == nil || IsNil(o.Technology) {
		return nil, false
	}
...
func (o *AssetDetailed2) HasTechnology() bool {
	if o != nil && !IsNil(o.Technology) {
		return true
	}
...
func (o *AssetDetailed2) SetTechnology(v AssetTechnologyDetailed) {
	o.Technology = &v
}
