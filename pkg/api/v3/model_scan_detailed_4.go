...
// checks if the ScanDetailed4 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &ScanDetailed4{}

// ScanDetailed4 The scan of the event
type ScanDetailed4 struct {
	// The id of the scan
	Id string `json:"id"`
...
type _ScanDetailed4 ScanDetailed4

// NewScanDetailed4 instantiates a new ScanDetailed4 object
// This constructor will assign default values to properties that have it defined,
// and makes sure properties required by API are set, but the set of arguments
// will change when the set of required properties is changed
func NewScanDetailed4(id string, status string, createdAt string, updatedAt string, duration float32, progressRatio float32, initiator string, kind string, profileId string, organizationId string, links ScanDetailedLinks) *ScanDetailed4 {
	this := ScanDetailed4{}
	this.Id = id
	this.Status = status
...
// NewScanDetailed4WithDefaults instantiates a new ScanDetailed4 object
// This constructor will only assign default values to properties that have it defined,
// but it doesn't guarantee that properties required by API are set
func NewScanDetailed4WithDefaults() *ScanDetailed4 {
	this := ScanDetailed4{}
	return &this
}

// GetId returns the Id field value
func (o *ScanDetailed4) GetId() string {
	if o == nil {
		var ret string
		return ret
	}
...
func (o *ScanDetailed4) GetIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Id, true
...
func (o *ScanDetailed4) SetId(v string) {
	o.Id = v
}

// GetStatus returns the Status field value
func (o *ScanDetailed4) GetStatus() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetStatusOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetStatus(v string) {
	o.Status = v
}

// GetCreatedAt returns the CreatedAt field value
func (o *ScanDetailed4) GetCreatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetCreatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetCreatedAt(v string) {
	o.CreatedAt = v
}

// GetUpdatedAt returns the UpdatedAt field value
func (o *ScanDetailed4) GetUpdatedAt() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetUpdatedAtOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetUpdatedAt(v string) {
	o.UpdatedAt = v
}

// GetFinishedAt returns the FinishedAt field value if set, zero value otherwise.
func (o *ScanDetailed4) GetFinishedAt() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetFinishedAtOk() (*string, bool) {
	if o == nil || IsNil(o.FinishedAt) {
		return nil, false
	}
...
func (o *ScanDetailed4) HasFinishedAt() bool {
	if o != nil && !IsNil(o.FinishedAt) {
		return true
	}
...
func (o *ScanDetailed4) SetFinishedAt(v string) {
	o.FinishedAt = &v
}

// GetScore returns the Score field value if set, zero value otherwise.
func (o *ScanDetailed4) GetScore() float32 {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetScoreOk() (*float32, bool) {
	if o == nil || IsNil(o.Score) {
		return nil, false
	}
	return o.Score, true
...
func (o *ScanDetailed4) HasScore() bool {
	if o != nil && !IsNil(o.Score) {
		return true
	}
...
func (o *ScanDetailed4) SetScore(v float32) {
	o.Score = &v
}

// GetCoverage returns the Coverage field value if set, zero value otherwise.
func (o *ScanDetailed4) GetCoverage() float32 {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetCoverageOk() (*float32, bool) {
	if o == nil || IsNil(o.Coverage) {
		return nil, false
	}
...
func (o *ScanDetailed4) HasCoverage() bool {
	if o != nil && !IsNil(o.Coverage) {
		return true
	}
...
func (o *ScanDetailed4) SetCoverage(v float32) {
	o.Coverage = &v
}

// GetDuration returns the Duration field value
func (o *ScanDetailed4) GetDuration() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetDurationOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetDuration(v float32) {
	o.Duration = v
}

// GetProgressRatio returns the ProgressRatio field value
func (o *ScanDetailed4) GetProgressRatio() float32 {
	if o == nil {
		var ret float32
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetProgressRatioOk() (*float32, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetProgressRatio(v float32) {
	o.ProgressRatio = v
}

// GetInitiator returns the Initiator field value
func (o *ScanDetailed4) GetInitiator() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetInitiatorOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetInitiator(v string) {
	o.Initiator = v
}

// GetKind returns the Kind field value
func (o *ScanDetailed4) GetKind() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetKindOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Kind, true
...
func (o *ScanDetailed4) SetKind(v string) {
	o.Kind = v
}

// GetProfileId returns the ProfileId field value
func (o *ScanDetailed4) GetProfileId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetProfileIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetProfileId(v string) {
	o.ProfileId = v
}

// GetOrganizationId returns the OrganizationId field value
func (o *ScanDetailed4) GetOrganizationId() string {
	if o == nil {
		var ret string
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetOrganizationIdOk() (*string, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *ScanDetailed4) SetOrganizationId(v string) {
	o.OrganizationId = v
}

// GetCommitHash returns the CommitHash field value if set, zero value otherwise.
func (o *ScanDetailed4) GetCommitHash() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetCommitHashOk() (*string, bool) {
	if o == nil || IsNil(o.CommitHash) {
		return nil, false
	}
...
func (o *ScanDetailed4) HasCommitHash() bool {
	if o != nil && !IsNil(o.CommitHash) {
		return true
	}
...
func (o *ScanDetailed4) SetCommitHash(v string) {
	o.CommitHash = &v
}

// GetCommitBranch returns the CommitBranch field value if set, zero value otherwise.
func (o *ScanDetailed4) GetCommitBranch() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetCommitBranchOk() (*string, bool) {
	if o == nil || IsNil(o.CommitBranch) {
		return nil, false
	}
...
func (o *ScanDetailed4) HasCommitBranch() bool {
	if o != nil && !IsNil(o.CommitBranch) {
		return true
	}
...
func (o *ScanDetailed4) SetCommitBranch(v string) {
	o.CommitBranch = &v
}

// GetCommitAuthor returns the CommitAuthor field value if set, zero value otherwise.
func (o *ScanDetailed4) GetCommitAuthor() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetCommitAuthorOk() (*string, bool) {
	if o == nil || IsNil(o.CommitAuthor) {
		return nil, false
	}
...
func (o *ScanDetailed4) HasCommitAuthor() bool {
	if o != nil && !IsNil(o.CommitAuthor) {
		return true
	}
...
func (o *ScanDetailed4) SetCommitAuthor(v string) {
	o.CommitAuthor = &v
}

// GetCommitLink returns the CommitLink field value if set, zero value otherwise.
func (o *ScanDetailed4) GetCommitLink() string {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetCommitLinkOk() (*string, bool) {
	if o == nil || IsNil(o.CommitLink) {
		return nil, false
	}
...
func (o *ScanDetailed4) HasCommitLink() bool {
	if o != nil && !IsNil(o.CommitLink) {
		return true
	}
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetCommitAuthorProfilePictureLinkOk() (*string, bool) {
	if o == nil || IsNil(o.CommitAuthorProfilePictureLink) {
		return nil, false
	}
...
func (o *ScanDetailed4) HasCommitAuthorProfilePictureLink() bool {
	if o != nil && !IsNil(o.CommitAuthorProfilePictureLink) {
		return true
	}
...
func (o *ScanDetailed4) SetCommitAuthorProfilePictureLink(v string) {
	o.CommitAuthorProfilePictureLink = &v
}

// GetLinks returns the Links field value
func (o *ScanDetailed4) GetLinks() ScanDetailedLinks {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *ScanDetailed4) GetLinksOk() (*ScanDetailedLinks, bool) {
	if o == nil {
		return nil, false
	}
	return &o.Links, true
...
func (o *ScanDetailed4) SetLinks(v ScanDetailedLinks) {
	o.Links = v
}

func (o ScanDetailed4) MarshalJSON() ([]byte, error) {
...
func (o ScanDetailed4) ToMap() (map[string]interface{}, error) {
...
func (o *ScanDetailed4) UnmarshalJSON(data []byte) (err error) {
	...
	varScanDetailed4 := _ScanDetailed4{}

	err = json.Unmarshal(data, &varScanDetailed4)

	if err != nil {
		return err
	}

	*o = ScanDetailed4(varScanDetailed4)
...
type NullableScanDetailed4 struct {
	value *ScanDetailed4
	isSet bool
}

func (v NullableScanDetailed4) Get() *ScanDetailed4 {
	return v.value
}

func (v *NullableScanDetailed4) Set(val *ScanDetailed4) {
	v.value = val
	v.isSet = true
}

func (v NullableScanDetailed4) IsSet() bool {
	return v.isSet
}

func (v *NullableScanDetailed4) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableScanDetailed4(val *ScanDetailed4) *NullableScanDetailed4 {
	return &NullableScanDetailed4{value: val, isSet: true}
}

func (v NullableScanDetailed4) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableScanDetailed4) UnmarshalJSON(src []byte) error {
	v.isSet = true
