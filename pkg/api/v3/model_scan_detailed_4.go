...
func NewScanDetailed4(id string, status string, createdAt string, updatedAt string, finishedAt NullableString, score NullableFloat32, coverage NullableFloat32, duration float32, progressRatio float32, initiator string, kind string, profileId string, organizationId string, commitHash NullableString, commitBranch NullableString, commitAuthor NullableString, commitLink NullableString, commitAuthorProfilePictureLink NullableString, links ScanDetailedLinks) *ScanDetailed4 {
	this := ScanDetailed4{}
	this.Id = id
	this.Status = status
