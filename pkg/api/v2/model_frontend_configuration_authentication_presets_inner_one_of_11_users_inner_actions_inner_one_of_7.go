...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7(action EnumFOCUSPAGE, urlPattern string) *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7{}
	this.Action = action
	this.UrlPattern = urlPattern
	return &this
}

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7WithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 := _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7(varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7
	isSet bool
}

func (v NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7) Get() *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 {
	return v.value
}

func (v *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7) Set(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7 {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf7{value: val, isSet: true}
}
