...
type FrontendConfiguration struct {
	...
	FrontendCustomRules []FrontendConfigurationFrontendCustomRulesInner `json:"frontend_custom_rules,omitempty"`
	...
	SecurityTests *FrontendConfigurationSecurityTests `json:"security_tests,omitempty"`
...
func (o *FrontendConfiguration) GetFrontendCustomRules() []FrontendConfigurationFrontendCustomRulesInner {
	if o == nil || IsNil(o.FrontendCustomRules) {
		var ret []FrontendConfigurationFrontendCustomRulesInner
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FrontendConfiguration) GetFrontendCustomRulesOk() ([]FrontendConfigurationFrontendCustomRulesInner, bool) {
	if o == nil || IsNil(o.FrontendCustomRules) {
		return nil, false
	}
...
func (o *FrontendConfiguration) HasFrontendCustomRules() bool {
	if o != nil && !IsNil(o.FrontendCustomRules) {
		return true
	}
...
// SetFrontendCustomRules gets a reference to the given []FrontendConfigurationFrontendCustomRulesInner and assigns it to the FrontendCustomRules field.
func (o *FrontendConfiguration) SetFrontendCustomRules(v []FrontendConfigurationFrontendCustomRulesInner) {
...
func (o *FrontendConfiguration) GetSecurityTests() FrontendConfigurationSecurityTests {
	if o == nil || IsNil(o.SecurityTests) {
		var ret FrontendConfigurationSecurityTests
		return ret
	}
...
// and a boolean to check if the value has been set.
func (o *FrontendConfiguration) GetSecurityTestsOk() (*FrontendConfigurationSecurityTests, bool) {
	if o == nil || IsNil(o.SecurityTests) {
		return nil, false
	}
...
func (o *FrontendConfiguration) HasSecurityTests() bool {
	if o != nil && !IsNil(o.SecurityTests) {
		return true
	}
...
// SetSecurityTests gets a reference to the given FrontendConfigurationSecurityTests and assigns it to the SecurityTests field.
func (o *FrontendConfiguration) SetSecurityTests(v FrontendConfigurationSecurityTests) {
	o.SecurityTests = &v
}
