...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2(action EnumGOTO, url string) *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2{}
	this.Action = action
	this.Url = url
	return &this
}

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2WithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 := _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2(varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2
	isSet bool
}

func (v NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2) Get() *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 {
	return v.value
}

func (v *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2) Set(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2 {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf2{value: val, isSet: true}
}
