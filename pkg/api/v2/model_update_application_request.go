...
type UpdateApplicationRequest struct {
	...
	// The cron expression for the application. If not provided, the application will not be scheduled.
...
func (o *UpdateApplicationRequest) GetReadWrite() bool {
...
// and a boolean to check if the value has been set.
func (o *UpdateApplicationRequest) GetReadWriteOk() (*bool, bool) {
	if o == nil || IsNil(o.ReadWrite) {
		return nil, false
	}
...
func (o *UpdateApplicationRequest) HasReadWrite() bool {
	if o != nil && !IsNil(o.ReadWrite) {
		return true
	}
...
// SetReadWrite gets a reference to the given bool and assigns it to the ReadWrite field.
func (o *UpdateApplicationRequest) SetReadWrite(v bool) {
	o.ReadWrite = &v
}
