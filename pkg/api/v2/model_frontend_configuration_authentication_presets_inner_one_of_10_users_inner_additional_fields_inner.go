...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner(locator string, value string) *FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner{}
	this.Locator = locator
	this.Value = value
	return &this
}

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInnerWithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner := _FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner(varFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner
	isSet bool
}

func (v NullableFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner) Get() *FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner {
	return v.value
}

func (v *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner) Set(val *FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner(val *FrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf10UsersInnerAdditionalFieldsInner{value: val, isSet: true}
}
