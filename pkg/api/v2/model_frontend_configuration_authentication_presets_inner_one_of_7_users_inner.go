...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner(username string, headers map[string]string) *FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner{}
	this.Username = username
	this.Headers = headers
	return &this
}

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInnerWithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner := _FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner(varFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner
	isSet bool
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner(val *FrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf7UsersInner{value: val, isSet: true}
}
