...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6(action EnumWAITTEXT, value string, timeout float32) *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6{}
	this.Action = action
	this.Value = value
...
// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6WithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 := _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6(varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6
	isSet bool
}

func (v NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6) Get() *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 {
	return v.value
}

func (v *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6) Set(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6 {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf6{value: val, isSet: true}
}
