...
// checks if the FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner{}
...
type _FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner

// NewFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner instantiates a new FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner object
...
func NewFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner(name string, values []string) *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner {
	this := FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner{}
	this.Name = name
	this.Values = values
	return &this
}

// NewFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInnerWithDefaults instantiates a new FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner object
...
func (o *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner := _FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner(varFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner)
...
type NullableFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner struct {
	value *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner
	isSet bool
}

func (v NullableFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner) Get() *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner {
	return v.value
}

func (v *NullableFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner) Set(val *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner(val *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner) *NullableFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner {
	return &NullableFrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOfParametersHeadersInner{value: val, isSet: true}
}
