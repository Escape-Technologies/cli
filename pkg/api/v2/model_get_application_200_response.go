...
func NewGetApplication200Response(id string, name string, autogeneratedFromInventory bool, createdAt time.Time, hasCI bool, cron string, configuration GetApplication200ResponseConfiguration) *GetApplication200Response {
