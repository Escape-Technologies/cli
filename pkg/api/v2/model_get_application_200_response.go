...
type GetApplication200Response struct {
	...
	Configuration CreateApplicationRequestAnyOfConfiguration `json:"configuration"`
	Schema *CreateApplicationRequestAnyOf1Schema `json:"schema,omitempty"`
...
func NewGetApplication200Response(id string, name string, autogeneratedFromInventory bool, createdAt time.Time, hasCI bool, cron string, type_ EnumA59e4e0f7039345a12220706339ba411, configuration CreateApplicationRequestAnyOfConfiguration) *GetApplication200Response {
...
func (o *GetApplication200Response) GetConfiguration() CreateApplicationRequestAnyOfConfiguration {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *GetApplication200Response) GetConfigurationOk() (*CreateApplicationRequestAnyOfConfiguration, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetApplication200Response) SetConfiguration(v CreateApplicationRequestAnyOfConfiguration) {
	o.Configuration = v
}

// GetSchema returns the Schema field value if set, zero value otherwise.
func (o *GetApplication200Response) GetSchema() CreateApplicationRequestAnyOf1Schema {
...
// and a boolean to check if the value has been set.
func (o *GetApplication200Response) GetSchemaOk() (*CreateApplicationRequestAnyOf1Schema, bool) {
	if o == nil || IsNil(o.Schema) {
		return nil, false
	}
...
// SetSchema gets a reference to the given CreateApplicationRequestAnyOf1Schema and assigns it to the Schema field.
func (o *GetApplication200Response) SetSchema(v CreateApplicationRequestAnyOf1Schema) {
	o.Schema = &v
}
