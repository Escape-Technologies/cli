...
func NewGetApplication200Response(id string, name string, autogeneratedFromInventory bool, createdAt time.Time, hasCI bool, cron string, configuration CreateApplicationRequestConfiguration) *GetApplication200Response {
...
func (o *GetApplication200Response) GetConfiguration() CreateApplicationRequestConfiguration {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *GetApplication200Response) GetConfigurationOk() (*CreateApplicationRequestConfiguration, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *GetApplication200Response) SetConfiguration(v CreateApplicationRequestConfiguration) {
	o.Configuration = v
}
