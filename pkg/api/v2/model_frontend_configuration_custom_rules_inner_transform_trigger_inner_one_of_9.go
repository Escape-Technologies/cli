...
// checks if the FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9{}
...
type _FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9

// NewFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 instantiates a new FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 object
...
func NewFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9(if_ EnumREQUESTUSER) *FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 {
	this := FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9{}
	this.If = if_
	return &this
}

// NewFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9WithDefaults instantiates a new FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 object
...
func (o *FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 := _FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9{}

	err = json.Unmarshal(data, &varFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9(varFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9)
...
type NullableFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 struct {
	value *FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9
	isSet bool
}
...
func NewNullableFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9(val *FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9) *NullableFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9 {
	return &NullableFrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf9{value: val, isSet: true}
}
