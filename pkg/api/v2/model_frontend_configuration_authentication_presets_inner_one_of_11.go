...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf11 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf11{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf11 FrontendConfigurationAuthenticationPresetsInnerOneOf11

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11 instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11 object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf11(type_ EnumBROWSERACTIONS, users []FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInner, loginUrl string) *FrontendConfigurationAuthenticationPresetsInnerOneOf11 {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf11{}
	this.Type = type_
	this.Users = users
...
// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11WithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11 object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11) GetUsers() []FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInner {
	if o == nil {
		var ret []FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInner
		return ret
	}
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11) GetStealthMode() bool {
...
// and a boolean to check if the value has been set.
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11) GetStealthModeOk() (*bool, bool) {
	if o == nil || IsNil(o.StealthMode) {
		return nil, false
	}
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11) HasStealthMode() bool {
	if o != nil && !IsNil(o.StealthMode) {
		return true
	}
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11) SetStealthMode(v bool) {
	o.StealthMode = &v
}
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf11 := _FrontendConfigurationAuthenticationPresetsInnerOneOf11{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf11)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf11(varFrontendConfigurationAuthenticationPresetsInnerOneOf11)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11 struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf11
	isSet bool
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf11(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11 {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11{value: val, isSet: true}
}
