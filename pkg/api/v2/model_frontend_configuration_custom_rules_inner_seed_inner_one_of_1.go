...
// checks if the FrontendConfigurationCustomRulesInnerSeedInnerOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationCustomRulesInnerSeedInnerOneOf1{}
...
type _FrontendConfigurationCustomRulesInnerSeedInnerOneOf1 FrontendConfigurationCustomRulesInnerSeedInnerOneOf1

// NewFrontendConfigurationCustomRulesInnerSeedInnerOneOf1 instantiates a new FrontendConfigurationCustomRulesInnerSeedInnerOneOf1 object
...
func NewFrontendConfigurationCustomRulesInnerSeedInnerOneOf1(protocol EnumHTTP, raw string) *FrontendConfigurationCustomRulesInnerSeedInnerOneOf1 {
	this := FrontendConfigurationCustomRulesInnerSeedInnerOneOf1{}
	this.Protocol = protocol
	this.Raw = raw
	return &this
}

// NewFrontendConfigurationCustomRulesInnerSeedInnerOneOf1WithDefaults instantiates a new FrontendConfigurationCustomRulesInnerSeedInnerOneOf1 object
...
func (o *FrontendConfigurationCustomRulesInnerSeedInnerOneOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationCustomRulesInnerSeedInnerOneOf1 := _FrontendConfigurationCustomRulesInnerSeedInnerOneOf1{}

	err = json.Unmarshal(data, &varFrontendConfigurationCustomRulesInnerSeedInnerOneOf1)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationCustomRulesInnerSeedInnerOneOf1(varFrontendConfigurationCustomRulesInnerSeedInnerOneOf1)
...
type NullableFrontendConfigurationCustomRulesInnerSeedInnerOneOf1 struct {
	value *FrontendConfigurationCustomRulesInnerSeedInnerOneOf1
	isSet bool
}
...
func NewNullableFrontendConfigurationCustomRulesInnerSeedInnerOneOf1(val *FrontendConfigurationCustomRulesInnerSeedInnerOneOf1) *NullableFrontendConfigurationCustomRulesInnerSeedInnerOneOf1 {
	return &NullableFrontendConfigurationCustomRulesInnerSeedInnerOneOf1{value: val, isSet: true}
}
