...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner(username string, variables map[string]string) *FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner{}
	this.Username = username
	this.Variables = variables
	return &this
}

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInnerWithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner := _FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner(varFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner
	isSet bool
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner(val *FrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf4UsersInner{value: val, isSet: true}
}
