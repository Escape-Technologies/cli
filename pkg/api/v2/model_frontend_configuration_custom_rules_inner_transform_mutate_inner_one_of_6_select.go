...
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) GetType() FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Type {
...
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) GetTypeOk() (*FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Type, bool) {
	if o == nil || IsNil(o.Type) {
		return nil, false
	}
	return o.Type, true
...
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) SetType(v FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Type) {
	o.Type = &v
}

// GetName returns the Name field value if set, zero value otherwise.
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) GetName() FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Name {
...
// and a boolean to check if the value has been set.
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) GetNameOk() (*FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Name, bool) {
	if o == nil || IsNil(o.Name) {
		return nil, false
	}
	return o.Name, true
...
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) SetName(v FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Name) {
	o.Name = &v
}

// GetValue returns the Value field value if set, zero value otherwise.
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) GetValue() FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Name {
...
// and a boolean to check if the value has been set.
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) GetValueOk() (*FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Name, bool) {
	if o == nil || IsNil(o.Value) {
		return nil, false
	}
	return o.Value, true
...
func (o *FrontendConfigurationCustomRulesInnerTransformMutateInnerOneOf6Select) SetValue(v FrontendConfigurationCustomRulesInnerTransformTriggerInnerOneOf7Name) {
	o.Value = &v
}
