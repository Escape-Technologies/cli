...
type FrontendConfigurationCustomRulesInnerSeedInner struct {
	...
	FrontendConfigurationCustomRulesInnerSeedInnerOneOf2 *FrontendConfigurationCustomRulesInnerSeedInnerOneOf2
}
...
// FrontendConfigurationCustomRulesInnerSeedInnerOneOf2AsFrontendConfigurationCustomRulesInnerSeedInner is a convenience function that returns FrontendConfigurationCustomRulesInnerSeedInnerOneOf2 wrapped in FrontendConfigurationCustomRulesInnerSeedInner
func FrontendConfigurationCustomRulesInnerSeedInnerOneOf2AsFrontendConfigurationCustomRulesInnerSeedInner(v *FrontendConfigurationCustomRulesInnerSeedInnerOneOf2) FrontendConfigurationCustomRulesInnerSeedInner {
	return FrontendConfigurationCustomRulesInnerSeedInner{
		FrontendConfigurationCustomRulesInnerSeedInnerOneOf2: v,
	}
}
...
func (dst *FrontendConfigurationCustomRulesInnerSeedInner) UnmarshalJSON(data []byte) error {
	...
	// try to unmarshal data into FrontendConfigurationCustomRulesInnerSeedInnerOneOf2
	err = newStrictDecoder(data).Decode(&dst.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2)
	if err == nil {
		jsonFrontendConfigurationCustomRulesInnerSeedInnerOneOf2, _ := json.Marshal(dst.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2)
		if string(jsonFrontendConfigurationCustomRulesInnerSeedInnerOneOf2) == "{}" { // empty struct
			dst.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2 = nil
		} else {
			if err = validator.Validate(dst.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2); err != nil {
				dst.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2 = nil
			} else {
				match++
			}
...
func (src FrontendConfigurationCustomRulesInnerSeedInner) MarshalJSON() ([]byte, error) {
	...
	if src.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2 != nil {
		return json.Marshal(&src.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2)
	}
...
func (obj *FrontendConfigurationCustomRulesInnerSeedInner) GetActualInstance() (interface{}) {
	...
	if obj.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2 != nil {
		return obj.FrontendConfigurationCustomRulesInnerSeedInnerOneOf2
	}
