...
// checks if the FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1{}
...
type _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1

// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 object
...
func NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1(action EnumFILL, locator string, value string) *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 {
	this := FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1{}
	this.Action = action
...
// NewFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1WithDefaults instantiates a new FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 object
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 := _FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1(varFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1)
...
type NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 struct {
	value *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1
	isSet bool
}

func (v NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1) Get() *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 {
	return v.value
}

func (v *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1) Set(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1) {
	v.value = val
	v.isSet = true
}
...
func NewNullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1(val *FrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1) *NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1 {
	return &NullableFrontendConfigurationAuthenticationPresetsInnerOneOf11UsersInnerActionsInnerOneOf1{value: val, isSet: true}
}
