...
// checks if the CreateApplicationRequestConfigurationClient type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &CreateApplicationRequestConfigurationClient{}
...
func NewCreateApplicationRequestConfigurationClient() *CreateApplicationRequestConfigurationClient {
	this := CreateApplicationRequestConfigurationClient{}
	return &this
}

// NewCreateApplicationRequestConfigurationClientWithDefaults instantiates a new CreateApplicationRequestConfigurationClient object
...
func (o *CreateApplicationRequestConfigurationClient) GetRequestTimeout() float32 {
...
func (o *CreateApplicationRequestConfigurationClient) GetUserAgent() string {
...
// and a boolean to check if the value has been set.
func (o *CreateApplicationRequestConfigurationClient) GetUserAgentOk() (*string, bool) {
	if o == nil || IsNil(o.UserAgent) {
		return nil, false
	}
...
func (o *CreateApplicationRequestConfigurationClient) HasUserAgent() bool {
	if o != nil && !IsNil(o.UserAgent) {
		return true
	}
...
func (o *CreateApplicationRequestConfigurationClient) SetUserAgent(v string) {
	o.UserAgent = &v
}

// GetDiscretMode returns the DiscretMode field value if set, zero value otherwise.
func (o *CreateApplicationRequestConfigurationClient) GetDiscretMode() bool {
...
func (o *CreateApplicationRequestConfigurationClient) HasDiscretMode() bool {
	if o != nil && !IsNil(o.DiscretMode) {
		return true
	}
...
func (o *CreateApplicationRequestConfigurationClient) SetDiscretMode(v bool) {
	o.DiscretMode = &v
}

// GetMaxRequests returns the MaxRequests field value if set, zero value otherwise.
func (o *CreateApplicationRequestConfigurationClient) GetMaxRequests() float32 {
...
func (o *CreateApplicationRequestConfigurationClient) HasMaxRequests() bool {
	if o != nil && !IsNil(o.MaxRequests) {
		return true
	}
...
func (o *CreateApplicationRequestConfigurationClient) SetMaxRequests(v float32) {
	o.MaxRequests = &v
}

// GetProxyId returns the ProxyId field value if set, zero value otherwise.
func (o *CreateApplicationRequestConfigurationClient) GetProxyId() string {
...
// and a boolean to check if the value has been set.
func (o *CreateApplicationRequestConfigurationClient) GetProxyIdOk() (*string, bool) {
	if o == nil || IsNil(o.ProxyId) {
		return nil, false
	}
...
func (o *CreateApplicationRequestConfigurationClient) HasProxyId() bool {
	if o != nil && !IsNil(o.ProxyId) {
		return true
	}
...
func (o *CreateApplicationRequestConfigurationClient) SetProxyId(v string) {
	o.ProxyId = &v
}

func (o CreateApplicationRequestConfigurationClient) MarshalJSON() ([]byte, error) {
...
type NullableCreateApplicationRequestConfigurationClient struct {
	value *CreateApplicationRequestConfigurationClient
	isSet bool
}

func (v NullableCreateApplicationRequestConfigurationClient) Get() *CreateApplicationRequestConfigurationClient {
	return v.value
}

func (v *NullableCreateApplicationRequestConfigurationClient) Set(val *CreateApplicationRequestConfigurationClient) {
	v.value = val
	v.isSet = true
}

func (v NullableCreateApplicationRequestConfigurationClient) IsSet() bool {
	return v.isSet
}

func (v *NullableCreateApplicationRequestConfigurationClient) Unset() {
	v.value = nil
	v.isSet = false
}

func NewNullableCreateApplicationRequestConfigurationClient(val *CreateApplicationRequestConfigurationClient) *NullableCreateApplicationRequestConfigurationClient {
	return &NullableCreateApplicationRequestConfigurationClient{value: val, isSet: true}
}

func (v NullableCreateApplicationRequestConfigurationClient) MarshalJSON() ([]byte, error) {
	return json.Marshal(v.value)
}

func (v *NullableCreateApplicationRequestConfigurationClient) UnmarshalJSON(src []byte) error {
	v.isSet = true
