...
func (r ApiCreateLocationRequest) Execute() (*GetLocation200Response, *http.Response, error) {
...
func (a *LocationsAPIService) CreateLocationExecute(r ApiCreateLocationRequest) (*GetLocation200Response, *http.Response, error) {
	var (
...
func (r ApiGetLocationsRequest) Execute() ([]GetLocation200Response, *http.Response, error) {
...
// Execute executes the request
//  @return []GetLocation200Response
func (a *LocationsAPIService) GetLocationsExecute(r ApiGetLocationsRequest) ([]GetLocation200Response, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
