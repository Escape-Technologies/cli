...
func NewCreateIntegrationRequest(name string, parameters CreateIntegrationRequestParameters) *CreateIntegrationRequest {
...
func (o *CreateIntegrationRequest) GetParameters() CreateIntegrationRequestParameters {
	if o == nil {
...
// and a boolean to check if the value has been set.
func (o *CreateIntegrationRequest) GetParametersOk() (*CreateIntegrationRequestParameters, bool) {
	if o == nil {
		return nil, false
	}
...
func (o *CreateIntegrationRequest) SetParameters(v CreateIntegrationRequestParameters) {
	o.Parameters = v
}
