...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf10) GetStealthMode() bool {
...
// and a boolean to check if the value has been set.
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf10) GetStealthModeOk() (*bool, bool) {
	if o == nil || IsNil(o.StealthMode) {
		return nil, false
	}
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf10) HasStealthMode() bool {
	if o != nil && !IsNil(o.StealthMode) {
		return true
	}
...
func (o *FrontendConfigurationAuthenticationPresetsInnerOneOf10) SetStealthMode(v bool) {
	o.StealthMode = &v
}
