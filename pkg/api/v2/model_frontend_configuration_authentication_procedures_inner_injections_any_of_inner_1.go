...
// checks if the FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 type satisfies the MappedNullable interface at compile time
var _ MappedNullable = &FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1{}
...
type _FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1

// NewFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 instantiates a new FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 object
...
func NewFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1(location Enum08a525336b538128cd395ea29110b935, origin string, key string, variable string) *FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 {
	this := FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1{}
...
// NewFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1WithDefaults instantiates a new FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 object
...
func (o *FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1) UnmarshalJSON(data []byte) (err error) {
	...
	varFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 := _FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1{}

	err = json.Unmarshal(data, &varFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1)

	if err != nil {
		return err
	}

	*o = FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1(varFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1)
...
type NullableFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 struct {
	value *FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1
	isSet bool
}
...
func NewNullableFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1(val *FrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1) *NullableFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1 {
	return &NullableFrontendConfigurationAuthenticationProceduresInnerInjectionsAnyOfInner1{value: val, isSet: true}
}
