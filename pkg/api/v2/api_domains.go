...
func (r ApiCreateDomainRequest) Execute() (*GetDomains200ResponseInner, *http.Response, error) {
...
//  @return GetDomains200ResponseInner
func (a *DomainsAPIService) CreateDomainExecute(r ApiCreateDomainRequest) (*GetDomains200ResponseInner, *http.Response, error) {
	var (
		localVarHTTPMethod   = http.MethodPost
		localVarPostBody     interface{}
		formFiles            []formFile
		localVarReturnValue  *GetDomains200ResponseInner
	)
...
func (r ApiGetDomainsRequest) Execute() ([]GetDomains200ResponseInner, *http.Response, error) {
...
// Execute executes the request
//  @return []GetDomains200ResponseInner
func (a *DomainsAPIService) GetDomainsExecute(r ApiGetDomainsRequest) ([]GetDomains200ResponseInner, *http.Response, error) {
	var (
