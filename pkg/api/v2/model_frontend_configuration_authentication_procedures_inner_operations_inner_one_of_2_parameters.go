...
func (o *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOf2Parameters) GetStealthMode() bool {
...
// and a boolean to check if the value has been set.
func (o *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOf2Parameters) GetStealthModeOk() (*bool, bool) {
	if o == nil || IsNil(o.StealthMode) {
		return nil, false
	}
...
func (o *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOf2Parameters) HasStealthMode() bool {
	if o != nil && !IsNil(o.StealthMode) {
		return true
	}
...
func (o *FrontendConfigurationAuthenticationProceduresInnerOperationsInnerOneOf2Parameters) SetStealthMode(v bool) {
	o.StealthMode = &v
}
