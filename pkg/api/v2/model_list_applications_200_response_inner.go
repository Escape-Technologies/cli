...
func NewListApplications200ResponseInner(id string, name string, autogeneratedFromInventory bool, createdAt time.Time, hasCI bool, cron string) *ListApplications200ResponseInner {
...
func (o *ListApplications200ResponseInner) UnmarshalJSON(data []byte) (err error) {
	...
	err = decoder.Decode(&varListApplications200ResponseInner)
